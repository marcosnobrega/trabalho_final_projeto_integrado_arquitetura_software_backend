...
class ReviewResourceIT {
    ...
    public static Review createEntity(EntityManager em) {
        Review review = new Review().score(DEFAULT_SCORE).comment(DEFAULT_COMMENT);
        return review;
    }
    ...
    public static Review createUpdatedEntity(EntityManager em) {
        Review review = new Review().score(UPDATED_SCORE).comment(UPDATED_COMMENT);
        return review;
    }
    ...
    void putNewReview() throws Exception {
        ...
        updatedReview.score(UPDATED_SCORE).comment(UPDATED_COMMENT);
    ...
    void fullUpdateReviewWithPatch() throws Exception {
        ...
        partialUpdatedReview.score(UPDATED_SCORE).comment(UPDATED_COMMENT);

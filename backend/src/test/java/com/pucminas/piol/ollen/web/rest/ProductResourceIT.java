...
import com.pucminas.piol.ollen.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).stock(UPDATED_STOCK).image(UPDATED_IMAGE);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.image(UPDATED_IMAGE);

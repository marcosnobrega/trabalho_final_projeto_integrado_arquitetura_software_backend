...
import com.pucminas.piol.ollen.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().date(DEFAULT_DATE).amount(DEFAULT_AMOUNT);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().date(UPDATED_DATE).amount(UPDATED_AMOUNT);
        return order;
    }
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.date(UPDATED_DATE).amount(UPDATED_AMOUNT);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.date(UPDATED_DATE).amount(UPDATED_AMOUNT);
